...
if __name__ == "__main__":
    ...
    test = {"temperature": 1.0, "sigma": 1, "component": 1, "epsilon": 1., "wave": 1.0}
    mbwr = MBWR_EOS(test)
    mbwr.rho = [0.6]
    pressure = mbwr.pressure()
    print("pressure is equal to " + str(pressure))
    ...
    # test = {"temperature": 1.5, "sigma": [1, 1.1], "component": 2, "epsilon": [1.2, 1.], "wave": 1.0}
    # mbwr = MBWR_EOS(test)
    # mbwr.rho = [0.1, 0.2]
    # pressure = mbwr.pressure()
    # print("pressure is equal to " + str(pressure))
    ...
    # test1 = {"temperature": 1.5, "sigma": [1.1, 1.1], "component": 2, "epsilon": [1.2, 1.], "wave": 1.0}
    # mbwr = MBWR_EOS(test1)
    # mbwr.rho = [0.12, 0.0]
    # chemP = mbwr.exChemicalPotential()
    # print("chemical potential is equal to " + str(chemP))
